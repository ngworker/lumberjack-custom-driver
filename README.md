...
LumberjackCustomDriverModule.forRoot({
...
This library provides some basic `log-drivers` out of the box, the `ConsoleDriver` and the `LumberjackCustomDriver`.

> Note: Consider the LumberjackCustomDriver as an example of what can be achieved. It may not fit your app requirements.
...
For a more advanced example of a `driver` implementation check the [LumberjackCustomDriver](https://github.com/ngworker/lumberjack/blob/main/projects/ngworker/lumberjack/lumberjack-custom-driver/README.md)
