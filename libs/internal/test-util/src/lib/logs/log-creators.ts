...
export const createDebugLog = (message?: string, scope?: string) =>
  createLog(LumberjackLevel.Debug, message, scope);
export const createErrorLog = (message?: string, scope?: string) =>
  createLog(LumberjackLevel.Error, message, scope);
export const createInfoLog = (message?: string, scope?: string) => createLog(LumberjackLevel.Info, message, scope);
export const createTraceLog = (message?: string, scope?: string) =>
  createLog(LumberjackLevel.Trace, message, scope);
